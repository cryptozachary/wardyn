...
## Product Strategist
Full instructions loaded conditionally from memory/STRATEGIST.md.
Trigger phrases: "strategist mode", "find me ideas", "what should I build?", etc.
Data files: memory/idea_log.json, memory/signal_bank.json.
